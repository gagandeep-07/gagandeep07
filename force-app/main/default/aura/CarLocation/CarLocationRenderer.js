    ...
    rerender: function (component) {
        ...
        if (!location) {
            ...
            if (!component.map) {
                ...
                window.L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}', {attribution: 'Map © SFDCFacts'}).addTo(component.map);
            }
