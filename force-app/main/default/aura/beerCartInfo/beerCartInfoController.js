({
    goToCart : function(component, event, helper) {
        ...
        //getCartId create a cart and cartItems record and retrun the cart record ID
        ...
        action.setCallback(this, function(response){
            ...
            if(state === 'SUCCESS' || state === 'DRAFT'){
                console.log('Success getting BeerList items '+response.getReturnValue());
                
                var pageReference = component.find("navigation");
                var pageReferenceNav = {    
                    "type": "standard__component",
                    "attributes": {
                        "componentName": "c__beerCartDetails"    
                    },    
                    "state": {
                        //passing the cartId to beerCarsDetails Component
