({
    doInit : function(component, event, helper) {
        ...
        console.log('check the value is of Page reference '+pageReference);
        component.find('recordCreator').getNewRecord(
            ...
            $A.getCallback(function(){
                ...
                if(error || (record === null)){
                    ...
                    console.log('Templated Initiated');
                }
            })
        );
        
        var state = pageReference.state;
        console.log('Cart id in page reference '+ state.c__cartId);
        if(state.c__cartId != ''){
            ...
            action.setCallback(this, function(response){
                ...
                console.log('Success State for getCartItems'+stateResponse);
                if(stateResponse === 'SUCCESS' || stateResponse === 'DRAFT'){
                    var resultData = response.getReturnValue();
                    console.log('Able to get the cart items'+resultData);
                    console.log(' Number of cartitems in resultData ' , resultData.length);
                    var items = [];
                    var subTotal;
        ...
        console.log('not in page reference');
    },
    ...
    placeOrder : function(component, event, helper){
        ...
        if(selectedAdd){
            ...
            console.log('Current Logged User Id '+userId);
